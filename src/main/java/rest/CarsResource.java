...
public class CarsResource {
    ...
    public String insertData() {
        List<CarsDTO> all = new ArrayList();
          if(FACADE.getAllCars().isEmpty()){
              
              CarsDTO c1=FACADE.addNewCar(new Cars(1, 1993, "Ford", "Fiesta", 800, "img1"));
              CarsDTO c2=FACADE.addNewCar(new Cars(2, 1973, "Crysler", "Cristal", 1000, "img2"));
              CarsDTO c3=FACADE.addNewCar(new Cars(3, 2011, "Toyota", "Tuscana", 600, "img3"));
              CarsDTO c4=FACADE.addNewCar(new Cars(4, 1993, "Lamborghini", "Latvia", 900, "img4"));
              all.add(c1);
              all.add(c2);
              all.add(c3);
              all.add(c4);
